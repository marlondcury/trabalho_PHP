...
<<<<<<< HEAD
            <div class="col-md-4">
                <div class="card card-moderno h-100 p-4">
                    ...
                    <h4 class="fw-semibold">Categorias</h4>
                    <p class="text-muted mb-3">Gerencie as categorias e seus valores adicionais.</p>
                    <a href="categorias.php" class="btn btn-outline-primary mt-auto">Ver Categorias</a>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card card-moderno h-100 p-4">
                    <div class="icone-card">🔑</div>
                    <h4 class="fw-semibold">Exemplares</h4>
                    <p class="text-muted mb-3">Controle das unidades físicas do acervo.</p>
...
<<<<<<< HEAD
            <div class="col-md-6">
                <div class="card card-moderno h-100 p-4">
                    <div class="icone-card">🧾</div>
                    <h4 class="fw-semibold">Meu Cadastro</h4>
                    <p class="text-muted mb-3">Consulte e atualize seus dados pessoais.</p>
